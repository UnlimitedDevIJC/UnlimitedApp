      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView style={styles.scrollView} bounces={true}>
          ...
          <View style={{ width: "100%", height: "100%" }}>
            ...
            <TouchableOpacity style={styles.notificationBtn} onPress={() => navigation.navigate("SecondScreen")}>    
              <FontAwesome5 style={styles.notificationIcon} name="qrcode" />
            </TouchableOpacity>
            <View style={{ width: "100%", height: "100%", top: "-25%" }}>
              <View style={styles.titleView}>
                <Text style={styles.titleText}>Já conheces os nossos prémios?</Text>
              </View>
              <View style={styles.academiaLogoRetangulo}>
              <Text>jxdujxuduxdjujxuj
              efefmwmfwe
              fewfw eodeodemom</Text>
              </View>
              ...
              <FontAwesome5 style={styles.notificationIcon2} name="calendar-alt" />
            </View>
          </View>  
        </ScrollView>
      </SafeAreaView>
